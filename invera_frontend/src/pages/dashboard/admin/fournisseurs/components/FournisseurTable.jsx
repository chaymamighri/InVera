...
const FournisseurTable = ({ fournisseurs, onEdit, onToggleStatus }) => {
  ...
  if (!fournisseurs || fournisseurs.length === 0) {
    return (
      <div className="text-center py-12 bg-gradient-to-br from-emerald-50 to-blue-50 rounded-xl shadow-md">
        ...
        <h3 className="text-xl font-bold text-gray-800 mb-2">Aucun fournisseur</h3>
        <p className="text-base text-emerald-600">Commencez par ajouter un fournisseur</p>
      </div>
    );
  }
                ...
                >
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-8 w-8 rounded-full bg-gradient-to-r from-emerald-500 to-blue-500 flex items-center justify-center text-white font-bold text-sm shadow-sm flex-shrink-0">
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-sm font-medium ${
                        fournisseur.actif ? 'text-emerald-700' : 'text-gray-600'
                      }`}>
