...
import org.erp.invera.dto.erp.DashboardVente.DashboardDTO.ProduitVente;
...
public interface CommandeClientRepository extends JpaRepository<CommandeClient, Integer> {
    ...
    @Query("SELECT NEW org.erp.invera.dto.erp.DashboardVente.DashboardDTO$ProduitVente(" +
            "p.idProduit, p.libelle, SUM(l.quantite), SUM(l.sousTotal), p.imageUrl) " +
            ...
            "LIMIT :limit")
    List<ProduitVente> topProduits(@Param("debut") LocalDateTime debut,
                                   @Param("fin") LocalDateTime fin,
