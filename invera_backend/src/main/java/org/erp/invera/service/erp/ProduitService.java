...
public class ProduitService {
    ...
    public RowMapper<Produit> produitRowMapper() {
        return (rs, rowNum) -> {
            ...
            if (rs.getObject("categorie_id") != null) {
                ...
                try {
                    categorie.setRemiseStandard(rs.getDouble("categorie_remise_standard"));
                } catch (SQLException e) {
                    log.warn("Colonne categorie_remise_standard non trouvée: {}", e.getMessage());
                    categorie.setRemiseStandard(0.0);
                }
                produit.setCategorie(categorie);
                log.info(" Catégorie trouvée: id={}, nom={}, remise={}%",
                        categorie.getIdCategorie(), categorie.getNomCategorie(), categorie.getRemiseStandard());
            }
            ...
            if (fournisseurIdObj != null) {
                ...
                log.warn(" Aucun fournisseur_id trouvé pour ce produit");
            }
    ...
    public Produit createProduit(Produit produit, Integer fournisseurId, BigDecimal prixAchat, String token) {
        ...
        String insertSql = """
            INSERT INTO produit (libelle, prix_vente, prix_achat, quantite_stock, status, 
                                 ...
                                 created_by, created_at, categorie_id, fournisseur_id)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    public List<Produit> getAllProduits(String token) {
        ...
        SELECT p.*, 
               ...
               c.remise_standard as categorie_remise_standard,
    ...
    public List<Produit> getProduitsActifs(String token) {
        ...
        return tenantRepo.queryWithAuth(sql, produitRowMapperSimple(), clientId, authClientId);
    }
    ...
    public Optional<Produit> getProduitById(Integer id, String token) {
        ...
        if (produit != null) {
            ...
            if (produit.getFournisseur() != null) {
                ...
                log.warn("Aucun fournisseur attaché au produit ID={}", id);
            }
        } else {
            log.warn("Produit non trouvé pour ID: {}", id);
        }
    ...
    public Produit updateProduit(Integer id, Produit produitDetails, Integer fournisseurId,
        ...
        // ❌ SUPPRIMÉ : Double finalRemiseTemporaire
    ...
    public Produit reactiverProduit(Integer id, String token) {
        ...
        String selectSql = "SELECT * FROM produit WHERE id_produit = ?";
        return tenantRepo.queryForObjectAuth(selectSql, produitRowMapperSimple(), clientId, authClientId, id);
    }
